 ...
 *
 * ,-------------------------------------------.      ,------.  ,------.      ,-------------------------------------------.
 * |  Esc   |   1  |   2  |   3  |   4  |   5  |      |LShift|  |RShift|      |   6  |   7  |   8  |   9  |   0  |  Mute  |
 * |--------+------+------+------+------+------|      |------|  |------|      |------+------+------+------+------+--------|
 * |  Tab   |   Q  |   W  |   E  |   R  |   T  |      |LCtrl |  | RCtrl|      |   Y  |   U  |   I  |   O  |   P  |  Del   |
 * |--------+------+------+------+------+------|      |------|  |------|      |------+------+------+------+------+--------|
 * |  LGUI  |   A  |   S  |   D  |   F  |   G  |      | LAlt |  | RAlt |      |   H  |   J  |   K  |   L  | ;  : |  RGUI  |
 * |--------+------+------+------+------+------+------+------|  |------|------+------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |GShift|  | Mouse|      |   N  |   M  | ,  < | . >  | /  ? | RShift |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      | LAlt | LCtrl| Space| Num  |  | Sym  | Enter|  Nav | AltGr| Menu |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 *
 * ,----------------------------.      ,------.                 ,----------------------------.      ,------.
 ...
 */
    [_QWERTY] = LAYOUT_myr(
      KC_ESC  , KC_1 ,  KC_2   ,  KC_3  ,   KC_4 ,   KC_5 ,         KC_LSFT,     KC_RSFT,          KC_6 ,  KC_7 ,  KC_8 ,   KC_9 ,  KC_0 , KC_MUTE,
      ...
      KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , _______,  GSHFT,     MOUSE  , _______, KC_N ,  KC_M ,KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
                                 _______, KC_LALT, KC_LCTL, KC_SPC ,    NUM,     SYM    , KC_ENT , NAV  , KC_RALT, KC_APP,
 ...
 */
     [_NUM] = LAYOUT_myr(
       ...
       _______,  KC_P1 ,  KC_P2 ,  KC_P3 ,  KC_P4 ,  KC_P5 ,          _______, _______,           KC_P6 ,  KC_P7 ,  KC_P8 ,  KC_P9 ,  KC_P0 , _______,
       _______, KC_PDOT, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
 ...
 * |        |      |      |      |      |      |      |      |  |      |      |  ←   |   ↓  |   ↑  |   →  | VolDn| Insert |
 * |--------+------+------+------+------+------+------+------|  |------|------+------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      | RGB  |  |      |      |M Prev|M Stop|M Play|M Next|VolMut| PrtSc  |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |NumLck|      |      | Bksp |      |  |      |      |      |      |      |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 ...
 */
    [_NAV] = LAYOUT_myr(
       ...
       _______, _______, _______, _______, _______, _______, _______, ADJUST , _______, _______, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT, KC_MUTE, KC_PSCR,
                                  KC_NUM , _______, _______, KC_BSPC, _______, _______, _______, _______, _______, _______,
 ...
 */
     [_GSHFT] = LAYOUT_myr(
       ...
       KC_LSFT,  KC_Z  ,  KC_X  ,  KC_C  ,  KC_V  ,  KC_B  , _______, QWERTY , _______, _______, _______, _______, _______, _______, _______, _______,
 ...
 * |        |      |      |      |      |      |      |      |  |      | Mouse|      |      |      |      |      |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |WhlBtn|LClick| Prev |  | Next |RClick|      |      |      |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 *
 * ,-----------------------------.      ,------.                ,---------------------------.      ,------.
